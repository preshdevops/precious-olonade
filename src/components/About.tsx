      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <RevealOnScroll delay={0.4}>
            <div className="glass p-6 rounded-xl border-l-2 border-l-[#4A8FE7] mt-8 shadow-sm">
              <p className="font-heading italic text-lg text-[#4A8FE7] leading-relaxed">
        ...
        <div className="flex flex-col justify-center">
          <RevealOnScroll delay={0.2}>
            <h3 className="font-heading text-lg font-bold text-[#EDEBE4] mb-6 tracking-wide">
              Stack & Tools
            </h3>
          </RevealOnScroll>
          ...
          <div className="flex flex-wrap gap-3">
            {SKILLS.map((skill, idx) => (
              <RevealOnScroll key={skill} delay={0.3 + idx * 0.05}>
                <div className="glass glass-hover font-mono text-sm text-[#EDEBE4] px-4 py-2.5 rounded-xl cursor-default select-none shadow-sm hover:scale-[1.02]">
                  {skill}
                </div>
              </RevealOnScroll>
            ))}
